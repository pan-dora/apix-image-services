...
public class AcrepoFitsIT extends AbstractOSGiIT {
    ...
    public Option[] config() {
        ...
        return new Option[] {
            ...
            editConfigurationFilePut("etc/cool.pandora.exts.fits.cfg", "fcrepo.baseUrl", fcrepoBaseUrl),
            editConfigurationFilePut("etc/cool.pandora.exts.fits.cfg", "rest.port", fitsServicePort)
       };
    }
