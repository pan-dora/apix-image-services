...
public class AcrepoPcdmIT extends AbstractOSGiIT {
    ...
    public Option[] config() {
        ...
        return new Option[] {
            ...
            editConfigurationFilePut("etc/cool.pandora.exts.pcdm.cfg", "fcrepo.baseUrl", fcrepoBaseUrl),
            editConfigurationFilePut("etc/cool.pandora.exts.pcdm.cfg", "rest.port", pcdmExtPort)
       };
    }
