...
public class AcrepoBroadcastIT extends AbstractOSGiIT {
    ...
    public Option[] config() {
        ...
        return new Option[] {
            ...
            editConfigurationFilePut("etc/cool.pandora.connector.broadcast.cfg", "input.stream", inputStream),
            editConfigurationFilePut("etc/cool.pandora.connector.broadcast.cfg", "message.recipients",
                                     messageRecipients)
       };
    }
