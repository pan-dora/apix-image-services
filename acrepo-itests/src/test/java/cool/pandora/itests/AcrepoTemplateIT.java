...
public class AcrepoTemplateIT extends AbstractOSGiIT {
    ...
    public Option[] config() {
        ...
        return new Option[] {
            ...
            editConfigurationFilePut("etc/cool.pandora.exts.template.cfg", "fcrepo.baseUrl", fcrepoBaseUrl),
            editConfigurationFilePut("etc/cool.pandora.exts.template.cfg", "rest.port", templateServicePort),
            editConfigurationFilePut("etc/cool.pandora.exts.template.cfg", "ldpath.serviceUrl",
